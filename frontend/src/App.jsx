...
import CriminalDashboard from './components/CriminalDashboard'
...
function App() {
  ...
  const categories = [
    ...
    { 
      ...
      description: 'إدارة الحسابات البنكية، الحوالات المالية، وتثبيت الدفع الإلكتروني.'
    },
    { 
      id: 'REAL_ESTATE', 
      name: 'السجل العقاري', 
      ...
      description: 'إدارة العقارات، استعراض الملكية، وإشارات الحجز والرهن.'
    },
    { 
      id: 'CRIMINAL', 
      name: 'السجل العدلي - غير محكوم', 
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
        </svg>
      ),
      description: 'طلب وثيقة خلاصة السجل العدلي (غير محكوم) الفورية إلكترونياً.'
    }
  ];
          ...
          <div className="space-y-12">
            {!activeCategory ? (
              ...
              <div className="animate-fade-in space-y-10">
                ...
                {activeCategory === 'BANK' && <DigitalBank />}
                {activeCategory === 'REAL_ESTATE' && <MyProperties />}
                {activeCategory === 'CRIMINAL' && <CriminalDashboard />}
              </div>
            )}
          </div>
        )}
